...
* Enable custom application properties ```./gradlew kaptKotlin``` 
* Run the application: ```./gradlew bootRun``` the application is running at [http://localhost:8080/](http://localhost:8080/)
* Build jar
